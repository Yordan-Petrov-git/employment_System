...
public class GuiUtils {
    ...
    public static void showPassword(JToggleButton jToggleButton, JPasswordField passwordField) {
        if (jToggleButton.isSelected()) {//If button is presed
            jToggleButton.setIcon(new ImageIcon(new javax.swing.ImageIcon(GuiUtils.class.getResource("/Resources/Icons/pass_onn.png")).getImage().getScaledInstance(25, 30, Image.SCALE_SMOOTH)));
            ...
            jToggleButton.setIcon(new ImageIcon(new javax.swing.ImageIcon(GuiUtils.class.getResource("/Resources/Icons/pass_off.png")).getImage().getScaledInstance(25, 30, Image.SCALE_SMOOTH)));
        }
    }
